<template>
   <div>
    ...
    <v-form ref="form" lazy-validation>
        ...
        <v-text-field v-model="name" maxlength="40" :rules="nameRules" :counter="40" label="Name (e.g. Stefan)" required></v-text-field>
        ...
        <v-text-field v-model="phone" maxlength="10" :rules="phoneRules" :counter="10"
            ...
            label="Phone(e.g 0653334442)" required ></v-text-field>
